...
param.channels = 'CIO';          % can include following characters: C or D (color), O (orientation), I (intensity), F or X (flicker), M (motion)
...
param.blurRadius = 0.00;         % blur final saliency map (sigma=0.04 works well in my experience).
